...
const TourBookingPanel = ({ uuid, categoryDetails, name, duration, category }) => {
    ...
    <>
      <div className={styles['tour-booking-panel-outer']}>
        ...
        <div className={styles['tour-booking-button-pannel']}>
          ...
          <button className={styles['tour-booking-button']} onClick={() => setShowDialouge(true)}>Book Now</button>
